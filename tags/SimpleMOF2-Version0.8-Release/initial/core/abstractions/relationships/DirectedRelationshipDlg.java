...
public class DirectedRelationshipDlg extends hub.sam.mof.reflection.ObjectImpl implements DirectedRelationship
{
    public DirectedRelationshipDlg(hub.sam.mof.instancemodel.ClassInstance instance, hub.sam.mof.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public DirectedRelationshipDlg(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
