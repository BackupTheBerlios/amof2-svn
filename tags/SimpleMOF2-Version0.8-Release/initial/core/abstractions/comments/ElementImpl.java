...
public class ElementImpl extends hub.sam.mof.reflection.ObjectImpl implements Element
{
    ...
    public ElementImpl(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
