...
public class ElementImportDlg extends hub.sam.mof.reflection.ObjectImpl implements ElementImport
{
    public ElementImportDlg(hub.sam.mof.instancemodel.ClassInstance instance, hub.sam.mof.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public ElementImportDlg(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
    ...
    public String getName()  {
        return (String)invokeOperation("getName", new java.lang.Object[] {  });
    }
