...
public class Repository {
    ...
    public Repository() throws Exception {
        extents.put(CMOF_EXTENT_NAME, cmof.CMOF.createModel(CMOF_EXTENT_NAME));
    ...
    public Factory createFactory(Extent forExtent, cmof.Package forPackage) {
        return hub.sam.mof.reflection.FactoryImpl.createFactory((ExtentImpl)forExtent, forPackage);
    }
