...
public class CommentImpl extends hub.sam.mof.reflection.ObjectImpl implements Comment
{
    ...
    public CommentImpl(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
