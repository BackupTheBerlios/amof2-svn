...
public class UmlClassDlg extends hub.sam.mof.reflection.ObjectImpl implements UmlClass
{
    public UmlClassDlg(hub.sam.mof.instancemodel.ClassInstance instance, hub.sam.mof.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public UmlClassDlg(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
