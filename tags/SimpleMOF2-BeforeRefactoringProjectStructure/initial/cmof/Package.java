...
public interface Package extends cmof.PackageableElement, cmof.Namespace, core.basic.Package
{
    ...
    /**
     * <b>ownedMember</b>, multiplicity=(0,*), isComposite, isUnique, redefinedProperty = {cmof.Namespace.ownedMember}
     */
    public cmof.common.ReflectiveCollection<? extends cmof.PackageableElement> getOwnedMember();

    /**
     * <b>ownedType</b>, multiplicity=(0,*), isComposite, isUnique, subsettedProperty = {cmof.Package.ownedMember}, redefinedProperty = {core.basic.Package.ownedType}
     */
    public cmof.common.ReflectiveCollection<? extends cmof.Type> getOwnedType();

    /**
     * <b>nestedPackage</b>, multiplicity=(0,*), isComposite, isUnique, subsettedProperty = {cmof.Package.ownedMember}, redefinedProperty = {core.basic.Package.nestedPackage}
     */
