...
{
    public EnumerationImpl(cmofimpl.instancemodel.ClassInstanceImpl instance, cmofimpl.reflection.ExtentImpl extent) {
    ...
    public cmof.common.ReflectiveSequence<? extends cmof.EnumerationLiteral> getOwnedLiteral() {
        ...
        if (value == null) {
           return null;
            ...
            return new cmofimpl.util.TypeWrapperListImpl<cmof.EnumerationLiteral>((cmof.common.ReflectiveSequence)value);
        }
    }
