...
public class GeneralizationImpl extends cmofimpl.reflection.ObjectImpl implements Generalization
{
    public GeneralizationImpl(cmofimpl.instancemodel.ClassInstanceImpl instance, cmofimpl.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public GeneralizationImpl(cmofimpl.reflection.Identifier id, cmofimpl.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
