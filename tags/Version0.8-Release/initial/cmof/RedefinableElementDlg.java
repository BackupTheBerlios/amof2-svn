...
public class RedefinableElementDlg extends hub.sam.mof.reflection.ObjectImpl implements RedefinableElement
{
    public RedefinableElementDlg(hub.sam.mof.instancemodel.ClassInstance instance, hub.sam.mof.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public RedefinableElementDlg(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
