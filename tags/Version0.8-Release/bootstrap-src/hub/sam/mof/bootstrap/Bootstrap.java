...
public class Bootstrap {        
    ...
    public static void main(String[] args) throws Exception {
        ...
        StreamFactory streamFactory = new StreamFactory("./bootstrap/");
        for (Element element: mof.objectsOfType(null, true)) {                      
        ...
        hub.sam.mof.reflection.ExtentImpl.writeStaticModel("./bootstrap/cmof/" + mof.getName() + ".java", "cmof", "CMOF", mof);
    }
}
