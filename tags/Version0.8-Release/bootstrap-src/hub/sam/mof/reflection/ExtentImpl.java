...
public class ExtentImpl extends PackageImpl implements cmof.reflection.Extent {
    private ReflectiveCollection<hub.sam.mof.reflection.ObjectImpl> objects;
    ...
    private ExtentImpl(String name, boolean bootstrap, String path) {
        super(name);        
        objects = new SetImpl<hub.sam.mof.reflection.ObjectImpl>();
    ...
    protected final ValueSpecification<UmlClass,Property,java.lang.Object> specificationForValue(java.lang.Object value) {
        if (value instanceof hub.sam.mof.reflection.ObjectImpl) {
            hub.sam.mof.reflection.ObjectImpl object = (hub.sam.mof.reflection.ObjectImpl)value;
	...
	public cmof.reflection.Object query(String queryString) throws hub.sam.mof.reflection.query.ParseException {
