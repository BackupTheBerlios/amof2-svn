...
public class ObjectImpl implements cmof.reflection.Object {
    ...
    protected ObjectImpl(ClassInstance<UmlClass,Property,java.lang.Object> instance, ExtentImpl extent) {
        ClassifierSemantics<Property,Operation,String> semantics = null;
    ...
    private Method getCustomImplementation(Operation op, ObjectImpl delegate) {        
        Method result = null;
        try {
            Collection<java.lang.Class> javaParameter = new Vector<java.lang.Class>();
            for (Parameter param: op.getParameter()) {
                String javaName = javaMapping.getFullQualifiedJavaIdentifier(param.getType());
                javaParameter.add(Thread.currentThread().getContextClassLoader().loadClass(javaName)); 
            }
        
            result = delegate.getClass().getMethod(javaMapping.getJavaMethodNameForOperation(op), javaParameter.toArray(new java.lang.Class[] {}));
            if (result.getDeclaringClass() == delegate.getClass()) {
                return result;
            } else {
                return null;
    ...
    protected static ObjectImpl createFromObject(ObjectImpl object) {
        ...
        if (object.getMetaClass() instanceof ObjectImpl) {
            ObjectImpl metaClass = (ObjectImpl)object.getMetaClass();            
