...
public class ObjectImpl implements cmof.reflection.Object, core.abstractions.ownerships.Element, Cloneable {
	protected final boolean isStatic; //TODO
	
    private InstanceProxy instance;
    ...
    protected ObjectImpl(ClassInstanceImpl instance, ExtentImpl extent) {        
        this.instance = new InstanceProxy(instance, extent);
        this.extent = extent;
    ...
    protected void addDelegate(ObjectImpl delegate) {
    ...
    public cmof.UmlClass getMetaClass() {
		if (isStatic) {
			...
			return instance.getMetaClass();
		}
    }
    
    public ClassImpl getReflectionClass() {
        return new ClassImpl(extent, instance.getClassClass());
    }
    
    protected ClassInstanceImpl getClassInstance() {
    ...
    public java.lang.Object get(String propertyName) {
        ...
        Property property = instance.getPropertyForName(propertyName);
        if (property == null) {
    ...
    public java.lang.Object get(Property property) 
        ...
        ValueSpecificationList values = (ValueSpecificationList)instance.getProperty(property);
    ...
    public void set(Property property, java.lang.Object value) {
        ...
        if (property.getUpper() == 1) {
            ...
            ReflectiveSequence<? extends ValueSpecification> values = instance.getProperty(property);
            if (values.size() == 0) {
    ...
    public boolean isSet(Property property) {      
        if (instance == null) {
            ...
            return instance.getProperty(property).size() != 0;
        }
    }
    ...
    public void unset(Property property) { 
        ...
        instance.getProperty(property).removeAll(new cmofimpl.util.SetImpl<ValueSpecification>(instance.getProperty(property)));
    }
    ...
    public boolean isInstanceOfType(cmof.UmlClass type, boolean includeSubTypes) {
        ReflectiveCollection<cmof.UmlClass> allPossibleTypes = new cmofimpl.util.SetImpl<cmof.UmlClass>();
    ...
    private Method getCustomImplementation(Feature forFeature, ObjectImpl delegate) {
        Feature boundFeature = instance.getFinalFeature(forFeature);
        Method result = null;
        if (boundFeature instanceof Property) {
            try {
                result = delegate.getClass().getMethod(javaMapping.getJavaGetMethodNameForProperty((Property)boundFeature), new java.lang.Class[]{});
    ...
    public ReflectiveCollection<? extends Element> getOwnedElement() {
        return new cmofimpl.util.SetImpl<Element>();
    }
    ...
    public cmof.reflection.Object container() {
        if (isStatic) {
			...
			return extent.getObjectForInstance(instance.getInstance().getComposite());
        }
	}
	
	public ReflectiveCollection<cmof.reflection.Object> getComponents() {
		ReflectiveCollection<ElementInstanceImpl> contents = 
				instance.getInstance().getComponents();
		ReflectiveCollection<cmof.reflection.Object> result = 
				new cmofimpl.util.ListImpl<cmof.reflection.Object>();
		for (ElementInstanceImpl instance: contents) {
    ...
    protected static ObjectImpl createFromObject(ObjectImpl object) {
        ...
        for (String propertyName: object.instance.getPropertyNames()) {
    ...
    // implementation of unnesseary functionality   
