...
import core.abstractions.instances.InstanceValue;
import cmof.*;
...
public class ExtentImpl extends PackageImpl implements cmof.reflection.Extent {
    ...
    private final Map<ElementInstanceImpl, ObjectImpl> objectForInstance = new HashMap<ElementInstanceImpl, ObjectImpl>();
    private final Map<ObjectImpl, ClassInstanceImpl> instanceForObject = new HashMap<ObjectImpl, ClassInstanceImpl>();
    ...
    protected java.lang.Object valueForSpecification(ValueSpecification spec) {
        if (spec instanceof DataValue) {
            if (spec instanceof DataValueImpl) {
                return ((DataValueImpl)spec).getValue();
            } else {
                throw new RuntimeException("not implemented");
            }
        } else if (spec instanceof InstanceValue) {
            return objectForInstance.get(((InstanceValue)spec).getInstance());
        } else {
            throw new RuntimeException("assert");
        }
    }
    
    protected ObjectImpl getObjectForInstance(ElementInstanceImpl instance) {
        return objectForInstance.get(instance);
    }
    
    protected ValueSpecification specificationForValue(java.lang.Object value) {
        if (value instanceof cmofimpl.reflection.ObjectImpl) {
            ...
            return new InstanceValueImpl(instanceForObject.get((ObjectImpl)value));        
        } else if (value instanceof Integer) {
            return new PrimitiveDataValueImpl((Integer)value);
        } else if (value instanceof Long) {
            return new PrimitiveDataValueImpl((Long)value);
        } else if (value instanceof Boolean) {
            return new PrimitiveDataValueImpl((Boolean)value);
        } else if (value instanceof String) {
            return new PrimitiveDataValueImpl((String)value);
        } else {
            throw new RuntimeException("not implemented");
        }        
    }
    
    protected ReflectiveSequence<java.lang.Object> valuesForSpecificationList(ValueSpecificationList list) {
        return new ValueList(list);
    }
    
    class ValueList implements cmof.common.ReflectiveSequence<java.lang.Object> {
        private final ValueSpecificationList valueSpecs;
                
        private ValueList(ValueSpecificationList valueSpecs) {
        ...
        class ValueIterator implements Iterator<java.lang.Object> {
            private Iterator<ValueSpecification> specIterator = valueSpecs.iterator();
    ...
    protected void removeObject(ObjectImpl object, ClassInstanceImpl instance) {
