 ...
 * includes all model elements from UML2 Infrastructure.<p/> If any reflective
 * operation attempts to create cyclic containment, an
 * {@link CompositeViolation} is thrown.<p/> <b>Constraints</b>: No additional
 * constraints.<p/> <b>SemanticsClass</b>: Object is the superclass of all
 ...
 * the interaction between default values, null, isSet, and unSet.<p/>
 ...
 */
public interface Object extends core.abstractions.elements.Element {
	 ...
	 * {@link core.common.ReflectiveSequence} containing the values of the
