...
public class UmlClassDlg extends cmofimpl.reflection.ObjectImpl implements UmlClass
{
    public UmlClassDlg(cmofimpl.instancemodel.ClassInstanceImpl instance, cmofimpl.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public UmlClassDlg(cmofimpl.reflection.Identifier id, cmofimpl.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
    ...
    public cmof.common.ReflectiveCollection<? extends cmof.UmlClass> getSuperClass() {
        ...
        if (value == null) {
           return null;
            ...
            return new cmofimpl.util.TypeWrapperSetImpl<cmof.UmlClass>((cmof.common.ReflectiveCollection)value);
        }
    }
