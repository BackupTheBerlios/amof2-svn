...
public class InstanceSpecificationDlg extends cmofimpl.reflection.ObjectImpl implements InstanceSpecification
{
    public InstanceSpecificationDlg(cmofimpl.instancemodel.ClassInstanceImpl instance, cmofimpl.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public InstanceSpecificationDlg(cmofimpl.reflection.Identifier id, cmofimpl.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
