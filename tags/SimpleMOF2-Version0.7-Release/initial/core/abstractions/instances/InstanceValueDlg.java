...
public class InstanceValueDlg extends cmofimpl.reflection.ObjectImpl implements InstanceValue
{
    public InstanceValueDlg(cmofimpl.instancemodel.ClassInstanceImpl instance, cmofimpl.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public InstanceValueDlg(cmofimpl.reflection.Identifier id, cmofimpl.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
