...
public class InstanceValueImpl extends hub.sam.mof.reflection.ObjectImpl implements InstanceValue
{
    public InstanceValueImpl(hub.sam.mof.instancemodel.ClassInstance instance, hub.sam.mof.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public InstanceValueImpl(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
