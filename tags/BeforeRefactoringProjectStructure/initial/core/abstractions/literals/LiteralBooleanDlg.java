...
public class LiteralBooleanDlg extends hub.sam.mof.reflection.ObjectImpl implements LiteralBoolean
{
    public LiteralBooleanDlg(hub.sam.mof.instancemodel.ClassInstance instance, hub.sam.mof.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public LiteralBooleanDlg(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
