...
public class LiteralUnlimitedNaturalImpl extends hub.sam.mof.reflection.ObjectImpl implements LiteralUnlimitedNatural
{
    public LiteralUnlimitedNaturalImpl(hub.sam.mof.instancemodel.ClassInstance instance, hub.sam.mof.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public LiteralUnlimitedNaturalImpl(hub.sam.mof.reflection.Identifier id, hub.sam.mof.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
