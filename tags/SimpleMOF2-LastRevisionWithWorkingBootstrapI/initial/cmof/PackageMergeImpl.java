...
public class PackageMergeImpl extends cmofimpl.reflection.ObjectImpl implements PackageMerge
{
    public PackageMergeImpl(hub.sam.mof.instancemodel.ClassInstance instance, cmofimpl.reflection.ExtentImpl extent) {
        super(instance, extent);
    }
    public PackageMergeImpl(cmofimpl.reflection.Identifier id, cmofimpl.reflection.Identifier metaId, String implementationClassName, String[] delegateClassNames) {
