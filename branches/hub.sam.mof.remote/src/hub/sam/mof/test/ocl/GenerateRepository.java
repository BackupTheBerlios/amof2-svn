...
public class GenerateRepository {
    ...
    public static void main(String[] args) throws Exception {                      
        ...
        MofModelManager modelManager = new MofModelManager(repository);
        modelManager.loadM2Model("resources/models/test/ocl-tests.mdxml", XmiKind.md, "ocl-tests",
                "Package:model");
        modelManager.getM2Model().setJavaPackagePrefix("hub.sam.mof.test.ocl");
        repository.generateCode(modelManager.getM2Model().getExtent(), "resources/test/generated-src/");
    }
}
