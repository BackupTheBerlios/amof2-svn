...
public class MofCopyFluxBox extends AbstractFluxBox<cmof.reflection.Object,cmof.reflection.Object,Object> {
    ...
    /**
     * This is a callback implementation. It creates the copyies. The copies are based on key. Params is ignored.
     * @param key
     *        The object to copy. Must lay in the source extent. Must be a {@link ObjectImpl}.
     * @param params
     *        Is ignored.
     * @return
     *        The copy of key. Lays in the target extent. Has all the values that key has.
     */
    @Override
    protected cmof.reflection.Object createValue(cmof.reflection.Object key, Object params) {
        ...
        MofClassSemantics semantics = MofClassifierSemantics.createClassClassifierForUmlClass(metaClass);
